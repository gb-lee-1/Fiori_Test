sap.ui.define([
    ...
    function (Controller, JSONModel, MessageToast, ButtonType) {
        ...
        return Controller.extend("sync.cl3.test.controller.View5", {
            /**
            ...
            onInit: function () {
                ...
                this.getRouter.getRoute("RouteView5").attachPatternMatched(this._onRouteMatched, this);
