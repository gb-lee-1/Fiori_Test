			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"synccl3test-display": {
								"semanticObject": "synccl3test",
								"action": "display",
								"description": "평가 어플리케이션",
								"title": "Test App",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sync.cl3.test",
									"url": sap.ui.require.toUrl("sync/cl3/test")
								}
							}
						}
					}
